...
- `openGraph.images` / `twitter.images` use absolute `https://www.fuwhis.io.vn/open-graph/og-preview-thumbnail.png` and that file must exist under `public/open-graph/` (a missing file 404s as HTML and Facebook reports invalid image content type).
